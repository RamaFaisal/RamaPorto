          ...
          <div className="lg:col-span-7">
            <div className="lg:ms-5">
              ...
              <p className="text-slate-400 max-w-xl text-[15px]">
                I have successfully completed 100+ projects, specializing in
                building robust web and custom solutions. I have mastered my
                skills to deliver robust, efficient and user-friendly web
                applications.
              </p>
              <p className="text-slate-400 max-w-xl text-[15px] mt-6">
                My passion lies in developing efficient SaaS applications,
                robust APIs and dynamic web scrapers for automation and data
                collection
              </p>
